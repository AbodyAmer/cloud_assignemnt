...
class RequestShipping extends Component{
     ...
     constructor(props){
         ...
         this.arrived = this.arrived.bind(this)
          ...
          arrived(e){
            ...
            axios.put('/api/arrived', {id: this.props.history.location.state.shipment.shipment_id})
  ...
  <button 
  onClick={e => this.arrived(e)} disabled={this.state.disable}
  className='btn btn-primary' style={{marginRight: '10px'}}>Arrive Shipping</button>
